        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false, computedColumnSql: "[TotalAmount] - ([TotalAmount] * [Discount] / 100)"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoicesServices", x => new { x.InvoiceId, x.ServiceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentChairs", x => new { x.AppointmentId, x.ChairId });
                    table.ForeignKey(
                        name: "FK_AppointmentChairs_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "AppointmentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentChairs_Chairs_ChairId",
                        column: x => x.ChairId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentChairs_ChairId",
