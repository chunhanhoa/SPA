...
| GET | `/api/Booking/MyBookings` | Lịch hẹn của tôi | ✅ |
| POST | `/api/Booking/Create` | Tạo lịch hẹn mới | ❌ |
| GET | `/api/Booking/ManagementData` | Quản lý lịch hẹn (Admin) | ✅ |
| POST | `/api/Booking/{id}/UpdateStatus` | Cập nhật trạng thái | ✅ |
...
3. **JWT Token Issues**
   - Kiểm tra cấu hình JWT trong appsettings.json
   - Đảm bảo secret key đủ dài (tối thiểu 32 ký tự)
